package xenius.config;


import xenius.security.JwtAuthenticationEntryPoint;
import xenius.security.JwtFilter;
...
public class SecurityConfiguration implements WebMvcConfigurer {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()  // was cors().and() after http
                ...
                .authorizeRequests().antMatchers("/login", "/signup", "/getAllBands").permitAll()
